...
cv::Mat Tracking::GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const double &timestamp)
{
    ...
    if (mImRGB.channels() == 4)
        cv::cvtColor(mImRGB, mImRGB, CV_BGRA2BGR);
    mImGray = imRGB;
    mImDepth = imD;
...
void Tracking::CreateNewKeyFrame()
{
    ...
    // mpPointCloudMapping->insertKeyFrame( pKF, this->mImGray, this->mImDepth );  // New add. Grey
    mpPointCloudMapping->insertKeyFrame( pKF, this->mImRGB, this->mImDepth );  // New add. Color
